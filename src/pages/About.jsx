    ...
    <div className="bg-cream-200">
        ...
        <div className="mx-auto grid max-w-[1600px] grid-cols-1 items-center gap-12 md:grid-cols-2 md:gap-16">
          ...
          >
            ...
            <p className="mt-6 text-base font-light leading-[1.9] text-taupe-500">
              שמי מעיין ווקסלמן. המסע שלי לא התחיל מרוחניות או מקריסטלים. הוא התחיל מפיקוד בצבא
              ולימודי רפואה מערבית בהונגריה. הייתי בטוחה שהמסלול שלי ברור, להיות רופאה קונבנציונלית,
              בדיוק כמו אבא שלי שהוא מנתח אורטופד. אבל בתוך הלחץ, האינטנסיביות והמרדף המערבי, הרגשתי
              שמשהו מהותי חסר שם, המגע, וההקשבה האמיתית לנפש.
            </p>
            <p className="mt-6 text-base font-light leading-[1.9] text-taupe-500">
      ...
      <section className="bg-cream-300 px-6 py-24 text-center sm:px-10 md:py-32">
        ...
        >
          ...
          >
            מאחורי כל טיפול עומדות 14 שנות ניסיון קליני. לאחר לימודיי עבדתי כחמש שנים כמטפלת בכללית,
            ובהמשך בחרתי להתמחות ולעבור לקליניקה פרטית, המוקדשת כולה לבריאות האישה, לפוריות ולאיזון
            הורמונלי. ההכשרה שלי כוללת גם התמחות קלינית בעולם (בבתי חולים בסין, ובלימודי המשך ביפן),
            מתוך הבנה מעמיקה של גוף האישה ותוך שילוב בין הרפואה המערבית למזרחית.
          </motion.p>
        </motion.div>
