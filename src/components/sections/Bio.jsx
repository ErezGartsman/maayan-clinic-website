    ...
    <section id="about" className="scroll-mt-24 bg-cream-200 px-6 py-24 sm:px-10 md:scroll-mt-28 md:px-12 md:py-32 lg:px-16 xl:px-24">
      <div className="mx-auto grid max-w-[1600px] grid-cols-1 items-center gap-16 md:grid-cols-2 md:gap-12 lg:gap-20">
        ...
        >
          ...
          >
            המסע שלי התחיל בכלל בלימודי רפואה מערבית בהונגריה. חוויתי על בשרי מה זה מתח, לחץ וניתוק
            מהגוף. כשהגעתי לטיפול דיקור בפעם הראשונה, משהו נפתח. הבנתי שחסר לי המגע וההקשבה לנפש.
            היום, הקליניקה שלי היא ה-'Happy Place' של המטופלות שלי. מקום שלא באים אליו רק כדי לכבות
            שריפות, אלא כדי לטפל בשורש, להחזיר את הזרימה, ולשלב ידע קליני עם רפואה שרואה אותך באמת.
          </motion.p>
